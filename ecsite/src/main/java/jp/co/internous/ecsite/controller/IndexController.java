...
import jp.co.internous.ecsite.model.form.TorokuForm;
...
public class IndexController {
	...
	@RequestMapping("/toroku/api/duplicatedUserName")
	@ResponseBody
	public boolean duplicatedUserName(@RequestParam String userName) {		

		int count = userRepos.findByUserName(userName);
		return count > 0;
	}
	@ResponseBody
	@PostMapping("/toroku/api/registeUser")
	public boolean registeUserApi(@RequestBody TorokuForm f) {
